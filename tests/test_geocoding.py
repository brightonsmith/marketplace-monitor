...
def test_nominatim_geocoder_accepts_interactive_delay() -> None:
    geocoder = NominatimGeocoder(min_delay_seconds=1.0)
    assert geocoder._geocode.min_delay_seconds == 1.0
